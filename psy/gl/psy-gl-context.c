...
{
    self->shader_programs = g_hash_table_new_full(
            g_str_hash,
            g_str_equal,
            NULL,
            g_object_unref
...
psy_gl_context_class_init(PsyGlContextClass* class)
{
    ...
    PsyDrawingContextClass *drawing_context_class  = PSY_DRAWING_CONTEXT_CLASS(class);
    ...
    drawing_context_class->create_fragment_shader = psy_gl_create_fragment_shader;
